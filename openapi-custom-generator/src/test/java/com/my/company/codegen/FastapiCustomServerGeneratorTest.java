 ...
 * 1) Set a break point in FastapiCustomServerGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class FastapiCustomServerGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("fastapi-custom-server") // use this codegen library
              ...
              .setOutputDir("out/fastapi-custom-server"); // output directory
