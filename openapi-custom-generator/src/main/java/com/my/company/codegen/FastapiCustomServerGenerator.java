...
import myorg.openapitools.codegen.languages.MyAbstractPythonCodegen;

// public class PythonFastAPIServerCodegen extends AbstractPythonCodegen {
public class FastapiCustomServerGenerator extends MyAbstractPythonCodegen {  
    ...
    final Logger LOGGER = LoggerFactory.getLogger(FastapiCustomServerGenerator.class);

    protected String sourceFolder;

    private static final String SERVER_PORT = "serverPort";
    private static final String NAME = "fastapi-custom-server";
    ...
    public FastapiCustomServerGenerator() {
        super();
    ...
    public void postProcess() {
        ...
        System.out.println("# https://opencollective.com/openapi_generator/donate  shikina   aaa                     #");
        System.out.println("#                                                                              #");
