...
public class MyDefaultCodegen implements CodegenConfig {
    private final Logger LOGGER = LoggerFactory.getLogger(MyDefaultCodegen.class);
    ...
    */
    ...
    public CodegenParameter fromParameter(Parameter parameter, Set<String> imports) {
        ...
        if (getUseInlineModelResolver() && !(true)) {
