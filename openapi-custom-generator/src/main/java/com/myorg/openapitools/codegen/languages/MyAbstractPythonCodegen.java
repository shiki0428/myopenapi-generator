...
package myorg.openapitools.codegen.languages;

// import myorg.opeapitools.codegen.MyDefaultCodegen;
...
public abstract class MyAbstractPythonCodegen extends MyDefaultCodegen implements CodegenConfig {
    private final Logger LOGGER = LoggerFactory.getLogger(MyAbstractPythonCodegen.class);

    protected String packageName = "openapi_client";
    protected String packageVersion = "1.0.3";
    protected String projectName; // for setup.py, e.g. petstore-api
    private Map<String, String> schemaKeyToModelNameCache = new HashMap<>();

    public MyAbstractPythonCodegen() {
        super();
